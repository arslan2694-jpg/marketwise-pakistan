...
| **Learn** | 18 chapter pages (overview, objectives, why it matters, sections, definitions, summary, quiz, flashcards) and 311 topic lessons, every one with at least one worked example (textbook or labelled practice). Each lesson has Beginner / MBA / Exam levels, four "Explain again" modes, conditions, principles, steps, examples, distinctions, common confusions, and the author's discussion of criticisms. There is a quick check, a source footer with "View source context", and **Teach me**, a guided walk through the topic. |
| **Explore** | Concept map (52 concepts along the book's spine, from the Islamic economic system through to Takaful), with search and group filters; every concept page has a relationship graph of its incoming and outgoing links, and every chapter's Study aids tab has an interactive topic-to-concept map. Glossary (191 book terms plus chapter definitions, with search, A–Z, categories, related terms and bookmarks). 25 step-through transaction diagrams, including Tawarruq, Ju‘alah, Hawalah, securitisation, Mudarabah Sukuk, running Musharakah, import L/C Murabaha, deposit pools and SBP’s export refinance scheme. Comparison lab (12 modes × 12 aspects, plus 25 paired comparisons). **Which mode applies?**, a decision tree with the disclaimer above. |
| **Practise** | Flashcards: 498 cards in chapter and category decks, with a deterministic spaced-review schedule (Again / Hard / Good / Easy). Quiz builder and 771 questions in 11 types, plus 311 quick checks. Every question has an answer, explanation, source, learning objective and a "Review topic" link. Adaptive practice driven by your answer history. **My mistakes** lists every question whose latest answer was wrong, grouped by chapter, with one-click retry; a question leaves the list once you answer it correctly. 19 case studies. **Interactive tools**: 23 calculators and rule checkers in one hub (Murabaha and Tawarruq checkers, Sukuk tradability, equity screening, floating rent with floor and cap, sleeping-partner and Mudarabah offset, Ju‘alah reward, late-payment penalty and more), each linked to its lesson. |
...
| **Guided study** | **Exam planner**: enter your exam date and get a day-by-day schedule of the topics you have not finished, in book order, with the last days kept for revision and a mock exam; it recalculates from your progress and shows a countdown on the dashboard. 45-minute crash course, 90-minute revision and 3-hour deep study. Each has a countdown, the current section, a completion track, and previous / next / skip / pause / resume. Your position is saved. |
...
- `node tests/e2e.cjs [filter]` runs the Playwright browser tests. They use the `playwright` library with Chromium, with no test-runner dependency. They cover:
  ...
  - interactive tools hub, concept relationship graphs, chapter concept maps and map filtering;
  - glossary, search, flashcard grading, quizzes, adaptive practice, cases, comparisons, diagrams, concept map and mode finder;
  - exam planner, notes, bookmarks, timer, and the crash course, revision and deep-study modes;
...
- **Practice material:** 6 of the 19 case studies and some calculator inputs are invented for practice and labelled "generated for learning". Their numbers are illustrative, not market data.
